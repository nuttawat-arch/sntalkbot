...
> **SNTalkBot 5.1.20:** role-isolated Full/Player/Manager operation, queue provenance and playlist sessions, Related Radio, bundled default YouTube cookies, a role-aware `status` dashboard, bounded Manager/Full `events`, and event-driven moderation for user/channel metadata updates.
