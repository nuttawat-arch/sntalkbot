...
สถานะเริ่มต้นของบอตจะบอกประเภทให้เห็นทันที เช่น `Player Bot | ส่วนตัวพิมพ์ h | ในห้องพิมพ์ /h`, `Server Manager Bot | ส่วนตัวพิมพ์ h | ในห้องพิมพ์ /h` หรือ `Full Bot (Player + Server Manager) | ส่วนตัวพิมพ์ h | ในห้องพิมพ์ /h` หากตั้งสถานะเองด้วย `cs <ข้อความ>` จะใช้ข้อความที่ตั้งไว้ และใช้ `cs auto` เพื่อกลับมาใช้สถานะตามประเภทบอต
