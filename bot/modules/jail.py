...
class JailCog:
    ...
    def register(self, command_handler):
        ...
        command_handler.register_command('jail', self.handle_jail_command, admin_only=True)
        command_handler.register_command('unjail', self.handle_unjail_command, admin_only=True)
        command_handler.register_command('jails', self.handle_jails_command, admin_only=True)
