...
class HelpCommands:
    ...
    def __init__(self, config_handler):
        ...
        self.commands = {
            ...
            '/h': self._('Show the command list one command per TeamTalk message.'),
            ...
            '/gl': self._('Alias for /l; get the current track URL.'),
            ...
            '/rs': self._('Alias for /restart.'),
            '/shutdown': self._('Admins only: Cleanly shut down the bot.'),
            '/sd': self._('Alias for /shutdown.'),
