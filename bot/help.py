...
class HelpCommands:
    ...
    def __init__(self, config_handler):
        ...
        self.commands = {
            ...
            '.': self._('Next search result. In queue mode, change the newest queued search item.'),
            ',': self._('Previous search result. In queue mode, change the newest queued search item.'),
