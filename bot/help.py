...
class HelpCommands:
    ...
    def __init__(self, config_handler):
        ...
        self.commands = {
            ...
            '/channelinput on|off|status': self._('Admins only: Enable, disable, or show channel input. When off, the bot ignores all channel text; private messages remain available. Short alias: ci.'),
