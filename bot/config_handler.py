...
class ConfigHandler:
    ...
    def _get_config_structure(self):
        ...
        return [
            ...
            {'section': 'bot', 'key': 'blacklist_mode', 'type': 'choice', 'prompt': self._("Action for Blacklisted Words"), 'help_text': self._("What to do when the master word filter finds a word from the multilingual blacklist.txt in a nickname or message."), 'options': {'Kick the user': '1', 'Ban the user': '2'}, 'default': 'Kick the user'},
    ...
    def get_bot_config(self):
        ...
        return {
            ...
            "channel_input_enabled": sec.getboolean("channel_input_enabled", True),
